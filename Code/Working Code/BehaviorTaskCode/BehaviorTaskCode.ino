...
const int ArraySize = 6; // Size of the array for water calculations
...
void solenoidOpenTime() {  /// function to determine the solenoid open time
  ...
  if (mouse_failed == 0) {  // Push Equation
    ...
    OpenTime = (-7.83 * (ArrayCount1 - ArrayCount2) / pow((ArrayCount1 + ArrayCount2), 2) - 18.44 * (ArrayCount1 - ArrayCount2) / (ArrayCount1 + ArrayCount2) + 48.28) * 0.5;
    }
